...
const CanvasObjectNode = React.memo(({
    ...
    return (
        ...
        >
            ...
            {el.type === 'visualizer4' && <VisualizerV4Renderer object={{ ...el, renderMode: (typeof window !== 'undefined' && window.m3RenderMode === 'fast' ? 'fast' : (el.renderMode || 'normal')) }} currentTimeSec={currentTime} width={el.width} height={el.height} />}
            {el.type === 'visualizer5' && <VisualizerV5Renderer object={{ ...el, renderMode: (typeof window !== 'undefined' && window.m3RenderMode === 'fast' ? 'fast' : (el.renderMode || 'normal')) }} currentTimeSec={currentTime} width={el.width} height={el.height} />}
