...
const CATEGORIES = [
  ...
  { id: 'Visualizer 3', icon: <Activity size={18} strokeWidth={1.75} className="text-emerald-400" />, label: 'Visualizer 3' },
  { id: 'Visualizer 4', icon: <Zap size={18} strokeWidth={1.75} className="text-orange-400 animate-pulse" />, label: 'Visualizer 4' },
