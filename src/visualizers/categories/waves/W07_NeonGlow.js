...
export const metadata = {
    id: 'waves-neon-glow',
    name: 'NeonGlow',
    displayName: 'Neon Glow Wave',
    description: 'Oscilloscope with high dynamic range bloom',
    category: 'Waves',
...
export function render(context) {
    ...
    // Draw outer glow
    drawWave(20, 0.3, (thickness || 2) * 3);
    // Draw inner glow
    drawWave(10, 0.6, (thickness || 2) * 1.5);
    // Draw core
    ctx.shadowBlur = 0;
    drawWave(0, 1.0, thickness || 2);
}
