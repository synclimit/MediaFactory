...
export const metadata = {
    id: 'waves-filled-sine',
    name: 'FilledSine',
    displayName: 'Filled Sine Wave',
    description: 'A continuous wave filled to the bottom of the screen',
    category: 'Waves',
...
export function render(context) {
    ...
    const { color, gain, smoothing } = config;
