...
export const metadata = {
    id: 'waves-dot-matrix',
    name: 'DotMatrixWave',
    displayName: 'Dot Matrix Wave',
    description: 'Waveform plotted as discrete dots',
    category: 'Waves',
...
export function render(context) {
    ...
    const sampleRate = 2; // don't draw every single pixel
