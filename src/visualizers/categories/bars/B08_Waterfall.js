...
export const metadata = {
    id: 'bars-waterfall',
    name: 'Waterfall',
    displayName: 'Waterfall / Spectrogram',
    description: 'Falling spectrogram lines',
    category: 'Bars',
