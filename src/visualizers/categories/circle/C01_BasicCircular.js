...
export const metadata = {
    id: 'circle-basic',
    name: 'BasicCircular',
    displayName: 'Basic Circular Bars',
    description: 'Standard frequency bars arranged in a circle, facing outward',
    category: 'Circle',
...
export function render(context) {
    ...
    for (let i = 0; i < barCount; i++) {
        ...
        ctx.translate(cx, cy);
        ctx.rotate(angle);
        ctx.fillRect(-barWidth/2, r, barWidth, h);
        ctx.restore();
    }
}
