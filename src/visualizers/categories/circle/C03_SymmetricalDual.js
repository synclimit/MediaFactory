/**
 * C03_SymmetricalDual.js
 * Symmetrical Dual Circle
 */
import { MathUtils } from '../../utils/MathUtils';

export const metadata = {
    id: 'circle-symmetrical-dual',
    name: 'SymmetricalDual',
    displayName: 'Symmetrical Dual Circle',
    description: 'Bars extending both inward and outward from the ring',
    category: 'Circle',
...
export function render(context) {
    ...
    for (let i = 0; i < barCount; i++) {
        ...
        ctx.translate(cx, cy);
        ctx.rotate(angle);
        ctx.fillRect(-barWidth/2, r - h, barWidth, h*2);
        ctx.restore();
    }
}
