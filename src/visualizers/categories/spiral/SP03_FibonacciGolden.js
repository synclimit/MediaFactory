...
export const metadata = {
    id: 'spiral-fibonacci',
    name: 'FibonacciGolden',
    displayName: 'Fibonacci Golden Spiral',
    description: 'A spiral based on the golden ratio',
    category: 'Spiral',
...
export function render(context) {
    ...
    for (let i = 0; i <= points; i++) {
        ...
        const r = 5 * Math.pow(phi, (2 * theta) / Math.PI);
        
        const dataIdx = Math.floor((i / points) * barCount) % barCount;
