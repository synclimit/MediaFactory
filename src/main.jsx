// Patch window.fetch to ensure relative /api endpoints always reach Express server on port 18888 in Electron with Node http fallback
if (typeof window !== 'undefined' && window.fetch) {
  ...
  window.fetch = function(input, init) {
    ...
    if (targetUrl.startsWith('/api')) {
      targetUrl = 'http://127.0.0.1:18888' + targetUrl;
    ...
    return _origFetch.call(this, input, init).catch(err => {
      ...
      if (typeof window !== 'undefined' && window.require && targetUrl.includes('127.0.0.1:18888')) {
        try {
